...
import { Brain, Search, Filter, Plus, Star, TrendingUp, X, ArrowRight } from 'lucide-react';
    ...
    <div className="min-h-screen bg-white dark:bg-black text-black dark:text-white transition-colors duration-300">
      ...
      <div className="relative z-10 pt-20">
        ...
        >
          <div className="text-center">
            <motion.button
              ...
              className="inline-flex items-center space-x-2 px-8 py-4 bg-gradient-to-r from-blue-500/20 to-purple-500/20 border border-blue-400/30 rounded-2xl text-white hover:from-blue-500/30 hover:to-purple-500/30 transition-all duration-200"
            >
            ...
            {showCreateRoadmap && (
              <div className="mt-6 p-6 bg-black/80 border border-white/10 rounded-2xl max-w-xl mx-auto">
                ...
                >
                  <input
                    ...
                    className="mb-3 w-full px-4 py-2 rounded-lg bg-gray-800 text-white border border-white/10 focus:outline-none focus:ring-2 focus:ring-blue-400 focus:border-transparent"
                  />
                  <textarea
                    name="description"
                    required
                  ...
                  <div className="flex gap-2 justify-end">
                    <button
                      type="button"
                      className="px-4 py-2 rounded-lg bg-gray-700 text-white font-medium hover:bg-gray-600 transition"
        ...
        <motion.div
          ...
          className="bg-gradient-to-br from-blue-900/30 to-purple-900/30 py-16 mt-16"
        >
          <div className="max-w-7xl mx-auto px-4">
            <div className="text-center mb-12">
              <h2 className="text-4xl font-bold text-white mb-4">Join the Community</h2>
              <p className="text-gray-100 text-lg max-w-2xl mx-auto">
                RoadmapAI is visited by thousands of developers every month. Be part of our growing community!
              </p>
            </div>
            
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-5xl mx-auto">
              {[
                { label: 'GitHub Stars', value: '10K+', icon: '⭐', color: 'text-yellow-300' },
                { label: 'Registered Users', value: '50K+', icon: '👥', color: 'text-blue-300' },
                { label: 'Roadmaps', value: '50+', icon: '🗺️', color: 'text-green-300' }
              ].map((stat, index) => (
                <motion.div
                  key={index}
                  whileHover={{ y: -5, scale: 1.03 }}
                  className="bg-white/5 backdrop-blur-sm rounded-2xl p-8 border border-white/10 shadow-lg hover:shadow-xl transition-all duration-300"
                >
                  <div className={`text-5xl mb-4 ${stat.color}`}>{stat.icon}</div>
            ...
            <div className="mt-12 text-center">
              <a
                href="#"
                className="inline-flex items-center px-8 py-3 bg-blue-600 hover:bg-blue-700 text-white font-medium rounded-lg text-lg transition-colors duration-200"
              >
                Join Now
      ...
      <footer className="w-full bg-black/80 py-6 mt-12 border-t border-white/10">
        <div className="max-w-7xl mx-auto px-4 flex flex-col md:flex-row items-center justify-between text-gray-300 text-sm">
          <div>
            © {new Date().getFullYear()} MOHIT SAI
          </div>
          <div className="flex items-center gap-4 mt-2 md:mt-0">
            <a href="https://www.linkedin.com/in/mohitsaipittu" target="_blank" rel="noopener noreferrer" className="hover:text-blue-400 underline">LinkedIn</a>
            <a href="mailto:mohitsai109@gmail.com" className="hover:text-blue-400 underline">mohitsai109@gmail.com</a>
          </div>
        </div>
      </footer>
